...
execute if score TimerActive Parameters matches 1 if score Tick timer_tick matches ..0 if score Second timer_second matches 1.. run data merge entity @e[type=armor_stand,tag=Timer,limit=1] {CustomName: {"score": {"name":"Second", "objective":"timer_second"}}}
